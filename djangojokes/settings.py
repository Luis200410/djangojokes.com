...
SECRET_KEY = 'django-insecure-_=n!f)4lcqk7*^v*$@pe!=57=l(_y4-x_9#fybd9=-&^!^82)2'
...
DEFAULT_FROM_EMAIL = 'luiseduardocastanedaruiz@gmail.com'
...
ACCOUNT_SIGNUP_FORM_CLASS = 'users.forms.SignupForm' # Custom signup form
...
AWS_STORAGE_BUCKET_NAME = 'djangojokesluis' # REPLACE WITH YOUR BUCKET NAME
